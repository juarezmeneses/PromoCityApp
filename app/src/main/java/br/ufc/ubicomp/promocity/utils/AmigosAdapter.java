...
import br.ufc.ubicomp.promocity.view.AmigosActivity;
...
public class AmigosAdapter extends ArrayAdapter<Usuario> {
    ...
    public AmigosAdapter(Context context, ArrayList<Usuario> lista) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(this.context).inflate(R.layout.item_lista_meus_amigos,null);
        ...
        Button buttonRemover = (Button)convertView.findViewById(R.id.buttonRemover);
            buttonRemover.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    itemPosicaoAux.setId(itemPosicao.getId());
                    new AmigosAdapter.removerAmigo().execute();
                }
            });
        return convertView;
    }
    ...
    public void removerAmigoJSON(){

        // Instantiate the RequestQueue.
        RequestQueue queue = Volley.newRequestQueue(this.context);
        String url = "http://18.207.202.131:8082/promocity/users/"+AmigosActivity.usuarioLogin.getId()+"/delete/friend/"+itemPosicaoAux.getId();
    ...
    private class removerAmigo extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String conteudo) {
            ...
            if(conteudoJson==""){
                Toast.makeText(context, "Não foi possível remover o amigo", Toast.LENGTH_SHORT).show();
                //kill_activity();
            } else {
        ...
        protected void onPreExecute() {
            ...
            dialog.setMessage("Removendo Amizade...");
            dialog.show();
        }
